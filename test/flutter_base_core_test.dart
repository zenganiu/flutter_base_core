...
void main() {
  group('flutter core', () {
    test('ExString', () {
      ...
      expect('17688'.dReplaceString(start: 1, end: 2, replacement: '#'), '1#688');
      ...
      expect('https:www.hao123.com'.dIsUrl, false);
    ...
    test('ExDate', () {
      ...
      expect(DateTime(2000, 12, 1).dFormat(pattern: 'yyyy/MM/dd'), '2000/12/01');
      expect(DateTime(2000, 1, 1, 11, 11, 11).dFormat(pattern: 'HH:mm:ss'), '11:11:11');
      expect(DateTime(2000, 1, 1, 01, 02, 13).dFormat(pattern: 'mm:ss'), '02:13');
    });
